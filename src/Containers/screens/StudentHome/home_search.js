...
const HomeSearch = ({ navigation }) => {
  return (
    ...
    <Text style={{color:"white", marginLeft: wp('13%'), marginTop:-25, fontSize: 16}}>Courses</Text>
      </Card>
      ...
      <SearchBar
          ...
          ></SearchBar>
          <Icon name="filter" size={20} style={{ marginTop:20, marginLeft: wp('3%'), color: "#0B774B" }}></Icon>
          </View>
      <Text style={{color:"#343434", marginLeft: wp('7%'), marginTop:10, fontSize: 14}}>Top Searches</Text>
        <View flexDirection="row" flexWrap="wrap" marginLeft={wp('3%')} height={hp('70%')}>
        {
