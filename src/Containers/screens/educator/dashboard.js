...
const Dashboard = ({ navigation }) => {
  return (
    ...
    <View style={{display: 'flex',
      ...
      padding:10}}>
        <View marginTop={20}>
            <Icon name="menu-outline" size={27} color="black"></Icon>
        </View>
        <View marginTop={20} marginLeft={wp('25%')}>
        <Text style={{color:"black", fontSize: 22}}>Dashboard</Text>
    </View>
    <Avatar image={require('../../../Assets/Images/avatar.jpeg')} style={{ marginLeft:'20%' }}></Avatar>
    </View>
    </Card>
    <NavTab></NavTab>
    <View style={{width: wp('100%'), marginLeft: wp('5%'), marginTop: 10}}>
  ...
  />
        ...
        <View style={{width: wp('95%')}}>
          ...
          <View style={{ display:'flex', flexDirection:"row", justifyContent:"space-between"}}>
          <Surface style={{ width: 180, height: 270, borderRadius: 16, margin: 10, padding: 10}}>
                <View style={{ display:'flex', flexDirection:"row", justifyContent:"space-between"}}>
                <Text>Mentors</Text>
                <Text>View all</Text>
                </View>
                <Image style={{ margin: 20 }} source={require('../../../Assets/Images/mentor.jpeg')}></Image>
                <View style={{ display:'flex', flexDirection:"row", justifyContent:"space-between"}}>
                  <Text>
                    Total Teachers
                  </Text>
                ...
                <View style={{ display:'flex', flexDirection:"row", justifyContent:"space-between"}}>
                <Button title="Add" color="#00AB65" titleStyle={{ color:"white", fontSize:10 }}/>
                <Button variant="outlined" title="Remove" color="#00AB65" width={85} titleStyle={{ fontSize:10 }} />
                </View>
            </Surface>
            <Surface style={{ width: 180, height: 270, borderRadius: 16, margin: 10, padding: 10}}>
                <View style={{ display:'flex', flexDirection:"row", justifyContent:"space-between"}}>
                ...
                <Image style={{ margin: 20 }} source={require('../../../Assets/Images/learner.jpeg')}></Image>
                <View style={{ display:'flex', flexDirection:"row", justifyContent:"space-between"}}>
                  <Text>
                    Total Teachers
                  </Text>
          ...
          <View style={{width: wp('95%')}}>
            ...
            <ScrollView>
                <Surface style={{ width: wp('100%'), height: 80, padding: 10, marginLeft: wp('5%')}}>
                  <View style={{ display:'flex', flexDirection:"row"}}>
                  <Avatar image={require('../../../Assets/Images/avatar.jpeg')}></Avatar>
                  <View style={{ padding:10 }}>
                  <Text style={{color:"black"}}>Paid to Syndra Thomas</Text>
                  <Text>12:48 am, 2 days ago</Text>
                  </View>
                  <Text style={{ fontSize: 20, padding:10, marginLeft:30, color:"#00AB65" }}>9800 INR</Text>
                  </View>
                </Surface>
                <Surface style={{ width: wp('100%'), height: 80, padding: 10, marginLeft: wp('5%')}}>
                  <View style={{ display:'flex', flexDirection:"row"}}>
